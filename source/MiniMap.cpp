...
namespace DEM
{
	...
	void Minimap::InitLocalMap()
	{
		...
		if (localMap)
		{
			...
			// Liam confirmed dialogue and sleep/wait should hide it, and Favor should not.
			{
	...
	void Minimap::Advance()
	{
		...
		if (IsVisible() && IsShown())
		{
			...
			// never being cleared. The accident was load-bearing. Confirmed in game by Liam: markers
