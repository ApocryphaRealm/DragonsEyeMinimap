...
**1.6.9 fixes a real crash 1.6.8 caused**, confirmed from an actual SKSE crash log (Liam hit
...
return null for `fHUDOpacity:Display` on Liam's system. Forming a reference off a null
