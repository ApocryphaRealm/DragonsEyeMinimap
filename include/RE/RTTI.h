...
{
	auto [from_rtti, vfDelta] = RE::get_dynamic_cast_info(a_from);

	void* from = from_rtti.get();

	REL::Relocation<void*> to_rtti{ RE::detail::remove_cvpr_t<To>::RTTI };
