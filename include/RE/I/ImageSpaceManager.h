...
#	include <include/RE/I/ImageSpaceManager.h>
#else
...
#define VR_RUNTIME_DATA_CONTENT                                                                                                                                                                    \
	...
	std::uint64_t unk218;																   /* 218, VR 240 */
		...
		void* CopyWithImageSpaceEffect(ImageSpaceEffectEnum a_effectIndex, RENDER_TARGET a_swap, RENDER_TARGET a_target, ImageSpaceShaderParam* a_param)
		{
			using func_t = decltype(&ImageSpaceManager::CopyWithImageSpaceEffect);
			REL::Relocation<func_t> func{ RELOCATION_ID(99025, 105676) };
