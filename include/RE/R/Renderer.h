...
#	include <include/RE/R/Renderer.h>
#else
...
#define RUNTIME_DATA_CONTENT                                                         \
	...
	RenderTargetData renderTargets[RENDER_TARGET::kTOTAL]; /* 0A58*/
		...
		public:
			...
			{
				using func_t = decltype(&Renderer::SetClearColor);
				REL::Relocation<func_t> func{ RELOCATION_ID(75463, 77249) };

				func(this, a_red, a_green, a_blue, a_alpha);
			}
